...
function preload() {
    ...
    this.load.image('background', 'tiled/assets/background.png');
    // Load the tileset image file, needed for the map to know what
    // tiles to draw on the screen
    this.load.image('tiles', 'tiled/assets/platformPack_tilesheet.png');
    ...
    this.load.image('spike', 'tiled/assets/spike.png');
    // Load the export Tiled JSON
    this.load.tilemapTiledJSON('map', 'tiled/assets/level1.json');
    // Load player animations from the player spritesheet and atlas JSON
    this.load.atlas('player', 'tiled/assets/kenney_player.png',
        'tiled/assets/kenney_player_atlas.json');
}
