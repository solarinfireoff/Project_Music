...
const main1 = new Phaser.Game(config);

function preload() {

    this.load.image('background', 'tiled/assets/background.png');
    this.load.atlas('player', 'tiled/assets/kenney_player.png','tiled/assets/kenney_player_atlas.json');
...
function create() {
    ...
    // Add the player to the main1 world
